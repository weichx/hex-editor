///<reference path="server/typings/i_file_system.d.ts"/>
///<reference path="server/typings/i_system.d.ts"/>

declare namespace Hex {
    export var createElement : (a : any, b : any, ...c : any[]) => any;
}

interface File {
    path : string; //added by node-webkit
}
